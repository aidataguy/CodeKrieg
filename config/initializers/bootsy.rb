...
Bootsy.setup do |config|
  ...
  config.small_image[:width] = 150
  #
  # Height limit for small images
  config.small_image[:height] = 150
  #
  #
  # MEDIUM IMAGES
  #
  # Width limit for medium images
  # config.medium_image[:width] = 800
  #
  # Height limit for medium images
  # config.medium_image[:height] = 600
  #
  #
  # LARGE IMAGES
  #
  # Width limit for large images
  # config.large_image[:width] = 1366
  #
  # Height limit for large images
  # config.large_image[:height] = 700
  #
  #
